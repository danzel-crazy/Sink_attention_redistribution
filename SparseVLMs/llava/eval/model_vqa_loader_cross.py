...
def eval_model(args):
    ...
    # cross-attention-sink-redistribution add-on: rebuild the pipeline objects from the real CLI
    # args (LlamaDynamicvitModel.__init__ only has `config` to work with - see the comment there
    # in modelling_sparse_llama.py).
    ...
    model.model.enable_cross_sink_redistribution = True
...
if __name__ == "__main__":
    ...
    # sink_token_selector (cross_attention_sink_redistribution_llava_sparsevlm/sink_tokens.py)
    ...
    # cross_attention_importants (cross_attention_sink_redistribution_llava_sparsevlm/cross_attention.py)
    parser.add_argument("--disable_sink_masked", action="store_false", dest="enable_sink_masked")

    # sink_attention_redistributor (cross_attention_sink_redistribution_llava_sparsevlm/attention_redistribution.py)
