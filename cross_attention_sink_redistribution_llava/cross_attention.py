"""Text-to-visual cross-attention scoring (class form).

This file is kept byte-identical to cross_attention_sink_redistribution/cross_attention.py
(the reference implementation) apart from the sink_tokens import above, which points at this
package's own copy so the package stays self-contained. Port any future change from there.
