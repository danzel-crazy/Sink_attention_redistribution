...
# Single-process (no chunking) - see scripts/FastV/textvqa.sh for the original LLaVA-repo pipeline.
...
EVAL_RESULT_FILE="${ANSWERS_DIR}/${EXP_NAME}_result.json"
python3 /tmp2/danzel/attention-bias/FastV/src/LLaVA/llava/eval/eval_textvqa.py \
