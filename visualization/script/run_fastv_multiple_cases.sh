...
RECEIVER_SELECTION_SOURCE=${RECEIVER_SELECTION_SOURCE:-}
RECEIVER_WEIGHT_SOURCE=${RECEIVER_WEIGHT_SOURCE:-}
...
case "${BENCHMARK}" in
  pope)
    ...
    DEFAULT_OUT="${REPO_ROOT}/visualization/snapshots/pope_single_case.pt"
    ;;
  textvqa)
    ...
    RECEIVER_TOKEN_COUNT=${RECEIVER_TOKEN_COUNT:=32}
    DEFAULT_OUT="${REPO_ROOT}/visualization/snapshots/textvqa_single_case.pt"
    ;;
  gqa)
    REFERENCE_DATASET_DIR="/project/aimm/pp/MTK/eval"
    ...
    REDISTRIBUTION_SOFTMAX_MODE=${REDISTRIBUTION_SOFTMAX_MODE:="resoftmax"}
    RECEIVER_TOKEN_COUNT=${RECEIVER_TOKEN_COUNT:=32}
    DEFAULT_OUT="${REPO_ROOT}/visualization/snapshots/gqa_single_case.pt"
    ;;
  mme)
    REFERENCE_DATASET_DIR="/project/aimm/pp/MTK/eval"
    ...
    DEFAULT_OUT="${REPO_ROOT}/visualization/snapshots/mme_single_case.pt"
    ;;
  *)
